...
// 🔥 FUNCIÓN MEJORADA PARA MODALES COMPACTOS
function forzarModalArriba(modal) {
    if (window.innerWidth <= 768) {
        console.log('📱 Aplicando diseño compacto para móvil...');
        ...
        if (modalDialog) {
            ...
            modalDialog.style.margin = 'auto'; // 🔥 CENTRADO
            modalDialog.style.maxWidth = '95%';
            modalDialog.style.maxHeight = '75%'; // 🔥 MÁS PEQUEÑO
        ...
        if (modalContent) {
            ...
            modalContent.style.maxHeight = '75vh'; // 🔥 MÁS PEQUEÑO
